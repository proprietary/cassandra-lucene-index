...
public final class DataHelper {
    ...
    static {
        masterData = new LinkedHashMap<>();
        masterData.put("ascii_1", "'ascii'");
        masterData.put("bigint_1", "1000000000000000");
        masterData.put("blob_1", "0x3E0A16");
        masterData.put("boolean_1", "true");
        masterData.put("decimal_1", "1000000000.0");
        masterData.put("date_1", String.valueOf(System.currentTimeMillis()));
        masterData.put("float_1", "1.0");
        masterData.put("inet_1", "'127.0.0.1'");
        masterData.put("text_1", "'text'");
        masterData.put("varchar_1", "'varchar'");
        masterData.put("uuid_1", "60297440-b4fa-11e3-8b5a-0002a5d5c51b");
        masterData.put("timeuuid_1", "a4a70900-24e1-11df-8924-001ff3591711");
        masterData.put("list_1", "['l1','l2']");
        masterData.put("set_1", "{'s1','s2'}");
        masterData.put("map_1", "{'k1':'v1','k2':'v2'}");
