...
public class Issue132Test extends BaseTest {

    @Test
    public void testUpdateSetRemovingUniqueComponentWide() {
        CassandraUtils utils = CassandraUtils.builder("issue_132_set_wide").withTable("test_wide_set")
    ...
    public void testUpdateListRemovingUniqueComponentWide() {
        CassandraUtils utils = CassandraUtils.builder("issue_132_list_wide").withTable("test_wide_list")
    ...
    public void testUpdateMapRemovingUniqueComponentWide() {
        CassandraUtils utils = CassandraUtils.builder("issue_132_map_wide").withTable("test_wide_map")
    ...
    public void testUpdateSetRemovingUniqueComponentSkinny() {
        CassandraUtils utils = CassandraUtils.builder("issue_132_set_skinny").withTable("test_skinny_set")
    ...
    public void testUpdateListRemovingUniqueComponentSkinny() {
        CassandraUtils utils = CassandraUtils.builder("issue_132_list_skinny").withTable("test_skinny_list")
    ...
    public void testUpdateMapRemovingUniqueComponentSkinny() {
        CassandraUtils utils = CassandraUtils.builder("issue_132_map_skinny").withTable("test_skinny_map")
