...
public class AllowFilteringWith1000SimilarRowsTest extends BaseTest {

    private static CassandraUtils utils;

    @BeforeAll
    public static void before() {
        utils = CassandraUtils.builder("filtering_1000_similar")
            ...
            .createTable()
            .createIndex();
        DataHelper.generateCustomInsertions(1000, utils);
        utils.refresh();
    }
    ...
    public void testAllowFiltering1000rows() {
        utils.searchAllWithFiltering(1000, "double_1", 1D).check(1000);
    }

    @Test
    public void testAllowFilteringAndLimit999() {
        utils.searchAllWithFiltering(999, "double_1", 1D).check(999);
    }

    @Test
    public void testAllowFilteringAndLimit1001() {
        utils.searchAllWithFiltering(1001, "double_1", 1D).check(1000);
    }
