...
import com.stratio.cassandra.lucene.util.CassandraUtilsUpdate;
...
public class BitemporalSearchTest extends BaseTest {
    ...
    public static void beforeClass() throws InterruptedException {
        Mapper mapper = bitemporalMapper("vt_from", "vt_to", "tt_from", "tt_to").pattern("yyyy/MM/dd HH:mm:ss.SSS")
            .validated(true);
        utils = CassandraUtils.builder("bitemporal")
        ...
        utils2 = CassandraUtils.builder("bitemporal2")
            .withPartitionKey("integer_1")
            .withClusteringKey()
            .withColumn("integer_1", "int")
            .withColumn("vt_from", "text")
    ...
    public void testBitemporalSearchIsWithInNowValueToString4() {
        ...
        CassandraUtils.builder("bitemporal2")
            .withPartitionKey("integer_1")
            .withClusteringKey()
            .withColumn("integer_1", "int")
            .withColumn("vt_from", "text")
    ...
    public void testBitemporalSearchOverBigIntsWithDefaultPattern() {
        ...
        CassandraUtils utils = CassandraUtils.builder("bitemporal3")
            .withPartitionKey("id")
    ...
    public void testBitemporalSearchFuture1() {
        CassandraUtils.builder("bitemporal_future")
            .withPartitionKey("integer_1")
            .withClusteringKey()
            .withColumn("integer_1", "int")
            .withColumn("vt_from", "text")
