...
import static com.stratio.cassandra.lucene.builder.Builder.geoShapeMapper;
...
public final class DataHelper {
    ...
    protected static final String[] CQL_TYPES = new String[]{"ascii", "bigint", "blob", "boolean", "date", "decimal", "double", "float", "inet", "int", "smallint", "text", "time", "timestamp",
    ...
    static {
        ...
        singleColumnMappersAcceptedTypes
            .put("integer", Sets.newHashSet("ascii", "bigint", "date", "decimal", "double", "float", "int", "smallint", "text", "timestamp", "tinyint", "varchar", "varint"));
        ...
        singleColumnMappersAcceptedTypes
            .put("string", Sets.newHashSet("ascii", "bigint", "boolean", "decimal", "double", "float", "inet", "int", "smallint", "text", "timeuuid", "tinyint", "uuid", "varchar", "varint"));
        singleColumnMappersAcceptedTypes
            .put("text", Sets.newHashSet("ascii", "bigint", "boolean", "decimal", "double", "float", "inet", "int", "smallint", "text", "timeuuid", "tinyint", "uuid", "varchar", "varint"));
    ...
    static {
        multipleColumnMappersAcceptedTypes
            .put(bitemporalMapper("vt_from", "vt_to", "tt_from", "tt_to"), Sets.newHashSet("ascii", "bigint", "date", "int", "text", "timestamp", "timeuuid", "uuid", "varchar", "varint"));
        ...
        multipleColumnMappersAcceptedTypes
            .put(geoPointMapper("latitude", "longitude"), Sets.newHashSet("ascii", "bigint", "decimal", "double", "float", "int", "smallint", "text", "varchar", "varint"));
    }
